...
function Avtorefarat() {
  const { data: booksData, loading, error } = useFetch("http://library.mebel-zakaz.uz/api/v1/abstracts/");
  ...
  return (
    <Container>
      <BooksText>AVTOREFARAT</BooksText>
      <SearchContainer>
        <SerachInput
          type="text"
